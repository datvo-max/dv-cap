...
import { ShieldAlert, LogIn, Loader2, LogOut } from "lucide-react";

export default function LoginScreen() {
  const { user, loading, login, logout, isAllowed } = useAuth();
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white max-w-md w-full rounded-2xl shadow-xl overflow-hidden border border-slate-100">
        <div className="bg-blue-600 p-8 text-center text-white">
          ...
          <p className="text-blue-100">Hệ thống Quản lý và Cấp phát Thẻ Căn cước</p>
        </div>
